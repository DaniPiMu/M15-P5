...
function draw() { // this function code runs in infinite loop
    ...
    if(singlePose) {
        ...
        image(monalisa, singlePose.leftShoulder.x-20, singlePose.leftShoulder.y+100, 50, 50);
        image(monalisa, singlePose.rightShoulder.x-20, singlePose.rightShoulder.y+100, 50, 50);
    }
